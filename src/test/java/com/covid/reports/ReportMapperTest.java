...
public class ReportMapperTest {
    ...
    public void convertToDto() {
        // given
        ReportEntity reportEntity = new ReportEntity(province, country, LocalDate.of(2020,01,01), cases, dead, recovered);
        ReportDto expectedReportDto = new ReportDto(province, country, reportDate, cases, dead, recovered);
        // when
        ReportDto actualReportDto = reportMapper.toDto(reportEntity);
        // then 
        assertThat(expectedReportDto.getProvince()).isEqualTo(actualReportDto.getProvince());
    ...
    public void converToEntity() {
        // given
        ReportDto reportDto = new ReportDto(province, country, reportDate, cases, dead, recovered);
        ReportEntity expectedReportEntity = new ReportEntity(province, country, LocalDate.of(2020,01,01), cases, dead, recovered);
        // when 
        ReportEntity actualReportEntity = reportMapper.toEntity(reportDto);
        // then
        assertThat(expectedReportEntity.getProvince()).isEqualTo(actualReportEntity.getProvince());
